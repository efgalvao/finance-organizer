...
RSpec.describe 'Investments::Treasury', type: :request do
  ...
  describe 'POST /invetments/treasuries' do
    ...
    context 'with valid data' do
      it 'creates a new Treasury', :aggregate_failures do
        expect { new_treasury }.to change(Investments::Treasury, :count).by(1)
  ...
  describe 'DELETE /investments/treasuries/:id   ' do
    ...
    context 'when successfully' do
      it 'deletes a treasury', :aggregate_failures do
        expect { delete_treasury }.to change(Investments::Treasury, :count).by(-1)
