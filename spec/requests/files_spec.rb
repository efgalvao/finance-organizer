...
RSpec.describe 'File', type: :request do
  ...
  describe 'POST /upload' do
    ...
    context 'with valid data' do
      before { allow(Files::ProcessFile).to receive(:call).with(any_args).and_return(true) }
    ...
    context 'with invalid data' do
      it 'has flash notice' do
        allow(Files::ProcessFile).to receive(:call).with(any_args).and_raise(StandardError)
